...
class Tabla_resultados_transporte(models.Model):
    ...
    answer1 = models.BooleanField(max_length=2, default="")
    answer2 = models.BooleanField(max_length=2, default="")
    answer3 = models.BooleanField(max_length=2, default="")
    answer4 = models.BooleanField(max_length=2, default="")
    answer5 = models.BooleanField(max_length=2, default="")
    answer6 = models.BooleanField(max_length=2, default="")
    answer7 = models.BooleanField(max_length=2, default="")
    answer8 = models.BooleanField(max_length=2, default="")
    answer9 = models.BooleanField(max_length=2, default="")
    answer10 = models.BooleanField(max_length=2, default="")
...
class Tabla_resultados_servicios(models.Model):
    ...
    answer9 = models.BooleanField(max_length=2, default="")
    answer10 = models.BooleanField(max_length=2, default="")
    answer11 = models.BooleanField(max_length=2, default="")
    answer12 = models.BooleanField(max_length=2, default="")
    answer13 = models.BooleanField(max_length=2, default="")
    answer14 = models.BooleanField(max_length=2, default="")
...
class Tabla_priorizacion_riesgos(models.Model):
    ...
    responsabilidad_civil_empresa = models.BooleanField(max_length=2, default="")
    equipos_moviles = models.BooleanField(max_length=2, default="")
    transporte_terrestre = models.BooleanField(max_length=2, default="")
    vehiculos_comerciales_livianos = models.BooleanField(max_length=2, default="")
    vehiculos_comerciales_pesados = models.BooleanField(max_length=2, default="")
    accidentes_personales = models.BooleanField(max_length=2, default="")
