# Generated by Django 2.2.7 on 2020-08-05 01:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('opciones_manejo', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='Poll.TablaManejoRiesgos')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('experiencia_empresa', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(500)], verbose_name='antigüedad')),
                ('direccion_empresa', models.CharField(default='', max_length=50, verbose_name='dirección')),
                ('ciudad_empresa', models.CharField(default='', max_length=20, verbose_name='ciudad')),
                ('comuna_empresa', models.CharField(default='', max_length=20, verbose_name='comuna')),
                ('razon_social_empresa', models.CharField(default='', max_length=100, verbose_name='razon social')),
                ('nombre_representante', models.CharField(default='', max_length=50, verbose_name='nombre')),
                ('rut_representante', models.CharField(max_length=12, verbose_name='rut')),
                ('email_representante', models.EmailField(default='', max_length=50, verbose_name='email')),
                ('telefono_representante', models.CharField(default='', max_length=15, verbose_name='teléfono')),
                ('ventas_anuales_empresa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Poll.TablaVentasAnuales', verbose_name='ventas anuales')),
            ],
        ),
        migrations.AddField(
